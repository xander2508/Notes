...
6. Attempt bruteforcing login portals using found credentials, see [[4. Post Exploitation/Generic Tooling/Hashes and Encryption/1. Guide#Brute-Forcing Guide|Guide]]
7. 
